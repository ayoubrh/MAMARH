 ...
 */
class Image extends \MAM\RHBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAM\\RHBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'MAM\\RHBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'MAM\\RHBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'MAM\\RHBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'MAM\\RHBundle\\Entity\\Image' . "\0" . 'tempFilename');
        }
