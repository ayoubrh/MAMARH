...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mam_rh.mailer' => 'getMamRh_MailerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'MAMRH', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MAM\\RHBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MAM\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MAM\\RHBundle\\Entity');
        $c->addDriver($b, 'MAM\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MAMRHBundle' => 'MAM\\RHBundle\\Entity', 'MAMUserBundle' => 'MAM\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e5a50b4bad9778743ee4022dfcecca5550fdf459f66d8bca51f9a9d67e74bcdb');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MAM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MAM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MAM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MAM\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MAM\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'mam_rh.mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MAM\RHBundle\MAMRHMailer\MAMRHMailer A MAM\RHBundle\MAMRHMailer\MAMRHMailer instance.
     */
    protected function getMamRh_MailerService()
    {
        return $this->services['mam_rh.mailer'] = new \MAM\RHBundle\MAMRHMailer\MAMRHMailer($this->get('swiftmailer.mailer.default'), $this->get('templating'), $this);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $p->setOptions(array('default_target_path' => '/app/ajoutemploye', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MAM\\RHBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MAM\\SiteBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MAM\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MAM\\RHBundle/Resources/views'), 'MAMRH');
        $instance->addPath(($this->targetDirs[3].'\\src\\MAM\\SiteBundle/Resources/views'), 'MAMSite');
        $instance->addPath(($this->targetDirs[3].'\\src\\MAM\\UserBundle/Resources/views'), 'MAMUser');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CHEF_PROJET' => array(0 => 'ROLE_EMP'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_CHEF_DEP', 1 => 'ROLE_EMP', 2 => 'ROLE_CHEF_PROJET', 3 => 'ROLE_RH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MAMRHBundle' => 'MAM\\RHBundle\\MAMRHBundle',
                'MAMSiteBundle' => 'MAM\\SiteBundle\\MAMSiteBundle',
                'MAMUserBundle' => 'MAM\\UserBundle\\MAMUserBundle',
            ...
            'fos_user.model.user.class' => 'MAM\\UserBundle\\Entity\\User',
